...
export namespace $default {
  export interface BaseEntity extends std.$Object {
  ...
  export interface GiftLog extends BaseEntity {
    "owner"?: ActivityCustomer | null;
    "customer_name"?: string | null;
    "remarks"?: string | null;
  }
  export interface InviterConfig extends BaseEntity {
    "activity": Activity;
    "inviter": User;
    "max_count"?: number | null;
  ...
  export interface SignLog extends BaseEntity {
    "owner"?: ActivityCustomer | null;
    "customer_name"?: string | null;
    "remarks"?: string | null;
  }
  ...
  export type UserType = "Unset" | "Employee" | "Customer" | "ShopManager";
  export interface current_user extends User {}
}
export type BaseEntity = $default.BaseEntity;
export type Activity = $default.Activity;
export type ActivityCustomer = $default.ActivityCustomer;
export type Gender = $default.Gender;
export type GiftLog = $default.GiftLog;
export type InviterConfig = $default.InviterConfig;
export type Permission = $default.Permission;
export type Role = $default.Role;
export type RolePermission = $default.RolePermission;
export type SignLog = $default.SignLog;
export type User = $default.User;
export type UserRole = $default.UserRole;
export type UserType = $default.UserType;
...
export namespace logs {
  export interface AuditLog extends std.$Object {
...
export interface types {
  ...
  "default": {
    "BaseEntity": $default.BaseEntity;
    "Activity": $default.Activity;
    "ActivityCustomer": $default.ActivityCustomer;
    "Gender": $default.Gender;
    "GiftLog": $default.GiftLog;
    "InviterConfig": $default.InviterConfig;
    "Permission": $default.Permission;
    "Role": $default.Role;
    "RolePermission": $default.RolePermission;
    "SignLog": $default.SignLog;
    "User": $default.User;
