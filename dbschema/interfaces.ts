...
export namespace $default {
  ...
  export interface Customer extends User {
    "activities": ActivityCustomer[];
    "shopCode"?: string | null;
    "shopName"?: string | null;
    "user_type"?: UserType | null;
  }
  export type Gender = "Unknown" | "Male" | "Female";
  export interface ShopManager extends User {
...
export type Customer = $default.Customer;
export type Gender = $default.Gender;
export type ShopManager = $default.ShopManager;
...
export interface types {
  ...
  "default": {
    ...
    "ShopManager": $default.ShopManager;
