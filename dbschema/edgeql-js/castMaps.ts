...
export type scalarAssignableBy<T extends $.ScalarType> =
  ...
  T extends _default.$UserType ? _default.$UserType : 
  T extends _default.$Gender ? _default.$Gender : 
...
type getSharedParentScalar<A, B> =
  ...
  A extends _fts.$ElasticLanguage ?
    ...
    never
  :
  A extends _default.$UserType ?
    B extends _default.$UserType ?
    B
    :
    never
  :
  A extends _default.$Gender ?
    B extends _default.$Gender ?
    B
    :
    never
  :
...
function getSharedParentScalar<A extends $.ScalarType, B extends $.ScalarType>(a: A, b: B): A | B {
  ...
  if (a.__name__ === "default::UserType") {
    if(b.__name__ === "default::UserType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
