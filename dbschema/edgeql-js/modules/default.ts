...
export type $ActivityλShape = $.typeutil.flatten<$BaseEntityλShape & {
  ...
  "cover_url": $.PropertyDesc<_std.$str, $.Cardinality.AtMostOne, false, false, false, false>;
  "image_base64": $.PropertyDesc<_std.$str, $.Cardinality.AtMostOne, false, false, false, false>;
  "image_crop": $.PropertyDesc<_std.$json, $.Cardinality.AtMostOne, false, false, false, false>;
  "image_size": $.PropertyDesc<_std.$int64, $.Cardinality.AtMostOne, false, true, false, false>;
...
export type $ActivityCustomerλShape = $.typeutil.flatten<$BaseEntityλShape & {
  ...
  "<inviter_customers[is Activity]": $.LinkDesc<$Activity, $.Cardinality.Many, {}, false, false,  false, false>;
  "<customers": $.LinkDesc<$.ObjectType, $.Cardinality.Many, {}, false, false,  false, false>;
  "<inviter_customers": $.LinkDesc<$.ObjectType, $.Cardinality.Many, {}, false, false,  false, false>;
